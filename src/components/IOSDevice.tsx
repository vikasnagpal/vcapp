...
// Ported from ios-frame.jsx — the iOS 26 device bezel, status bar, dynamic
// island and home indicator (light mode only, which is all the app uses).
...
export default function IOSDevice({ children, width = 402, height = 874 }: { children: ReactNode; width?: number; height?: number }) {
  return (
    <div
      style={{
        width,
